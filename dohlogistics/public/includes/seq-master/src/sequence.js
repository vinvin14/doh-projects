  ...
  var Sequence = (function (element, options) {
    ...
    self.manageEvents = {
      ...
      init: function() {
        ...
        // Used to start/stop Sequence when pages visibility changes
      ...
      add: {
        ...
        /**
         * When the pages loses visibility, pause autoPlay, then unpause when
         * the pages gains visibility again
         */
