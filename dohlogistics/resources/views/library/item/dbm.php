...
<div class="container-fluid">
    ...
    <div class="card card-body mt-2">
        <div class="d-flex justify-content-between">
            <span class="lead text-info">Existing DBM</span>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-fixed">
                ...
                <tr>
                    ...
                    <th scope="col" class="col-4">Unit</th>
                ...
                foreach (@$data['items'] as $item)
                {
                    echo '
                    <tr>
                        <td scope="row" class="col-4 titles">',$item->item,'</td>
                        <td class="col-4 titles">',$item->unit,'</td>
                        <td class="col-2 pl-4">',$item->price,'</td>
                        <td class="col-2"><a href="">View</a> </td>
                    </tr>
                    ';
                }
                ?>
...
<script>
    $(document).ready(function (){
        ...
        // libraryItems();
        // referenceBranch('#branch-selector', 'li');
